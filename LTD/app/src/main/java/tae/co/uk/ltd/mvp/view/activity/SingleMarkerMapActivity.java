 ...
 */
public class SingleMarkerMapActivity  extends AppCompatActivity {

    private GoogleMap mMap;
    private Disruption mDisruption;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_map);
        mDisruption = (Disruption) getIntent().getSerializableExtra(Constants.DISRUPTION_EXTRA);
        setUpMapProperly();
    }
    ...
    private void setUpMapProperly() {
        ...
        try {
            ...
            if (mMap != null) {
                ...
                addMarker(mDisruption.mLocation, mDisruption.mComments, mDisruption.mPoint.mLatitude, mDisruption.mPoint.mLongitude);
                addMakerEvent();
            } else {
